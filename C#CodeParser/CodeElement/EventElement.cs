...
{
    public class EventElement : AbsCodeElement
    {
        ...
        public string EventHandlerType { get; set; } = string.Empty;
            ...
            var parameters = new Dictionary<string, object>
    {
        ...
        { "paramEventHandlerType", EventHandlerType },
...
SET n += {{
    ...
    EventHandlerType: $paramEventHandlerType
}}";
